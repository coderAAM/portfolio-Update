            ...
            <div>
              ...
              <div className="space-y-4">
                {languageSkills.map((skill) => {
                  ...
                  return (
                    <div key={skill.name} className="flex items-center justify-between py-2 border-b border-border/50 last:border-0 hover:bg-primary/5 rounded-lg px-2 transition-colors">
            ...
            <div>
              ...
              <div className="space-y-4">
                {databaseSkills.map((skill) => {
                  ...
                  return (
                    <div key={skill.name} className="flex items-center justify-between py-2 border-b border-border/50 last:border-0 hover:bg-accent/5 rounded-lg px-2 transition-colors">
                      <div className="flex items-center gap-3">
                        <Icon className="h-5 w-5 text-muted-foreground" />
                        <span className="font-medium text-sm text-foreground">{skill.name}</span>
                      </div>
