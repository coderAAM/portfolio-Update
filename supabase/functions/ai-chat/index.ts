...
serve(async (req) => {
  ...
  try {
    ...
    if (type === "suggestion") {
      systemPrompt = `You are a professional content writer specializing in project descriptions. 
      ...
      If asked about specific projects or skills, provide helpful information based on context.
      For contact inquiries, encourage visitors to use the contact form.`;
    }
